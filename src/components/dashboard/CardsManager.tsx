    ...
    return (
        <div className="space-y-6 lg:space-y-10 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col items-center gap-4 lg:gap-6 p-4 lg:p-6 glass-card border-white/5 bg-white/[0.01]">
                ...
                <button
                    onClick={onUpgrade}
                    className="w-full lg:w-auto px-6 py-3 rounded-xl bg-white/[0.03] border border-white/10 text-[10px] font-black uppercase tracking-widest text-white hover:bg-white/10 transition-all flex items-center justify-center gap-2"
                >
                    Upgrade Tier
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="w-full lg:w-auto px-6 py-3 rounded-xl bg-primary text-black text-[10px] font-black uppercase tracking-widest hover:scale-105 disabled:opacity-50 disabled:hover:scale-100 transition-all shadow-[0_4px_20px_rgba(34,197,94,0.3)] flex items-center justify-center gap-2"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
                {cardsToDisplay.map((card, idx) => (
                    <div
                        key={card.id || idx}
                        className={cn(
                            "glass-card p-4 lg:p-6 bg-white/[0.01] border-white/5 space-y-4 lg:space-y-8 group relative overflow-hidden transition-all",
                    ...
                    >
                        ...
                        <div className="flex justify-between items-start">
                            <div className="flex items-center gap-3 lg:gap-4">
                                <div className="w-10 lg:w-12 h-10 lg:h-12 rounded-lg lg:rounded-xl bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden shrink-0">
                            ...
                            <div className={cn(
                                "px-2 lg:px-2.5 py-0.5 lg:py-1 rounded text-[8px] lg:text-[9px] font-black uppercase tracking-widest",
                        ...
                        <div className="space-y-2 lg:space-y-3">
                            <div className="flex justify-between text-[9px] lg:text-[10px] font-black uppercase tracking-[0.15em] lg:tracking-[0.2em] text-foreground/20">
                        ...
                        <div className="flex gap-2 lg:gap-3">
                            <button
                                ...
                                className="flex-grow py-2.5 lg:py-3 rounded-lg lg:rounded-xl bg-white/[0.03] border border-white/10 text-[9px] lg:text-[10px] font-black uppercase tracking-widest text-white/60 hover:bg-white/5 hover:text-white transition-all flex items-center justify-center gap-2"
                            >
                            ...
                            <button
                                ...
                                disabled={isMockState}
                                className="p-2.5 lg:p-3 rounded-lg lg:rounded-xl bg-white/[0.03] border border-white/10 text-white/60 hover:bg-white/5 hover:text-white transition-all"
                            >
